//
//  AccountRemoteAPIResponseHandler.swift
//  RXMVVMC
//
...
class AccountRemoteAPIResponseHandler: RemoteAPIResponseHandler {
    typealias EndPoint = Account
    func handleNetworkResponse(_ response: URLResponse?, data: Data?) -> Result<Void, Error> {
        ...
        case 401...499: return .failure(AccountRemoteAPIError(statusCode: response.statusCode, data: data))
