...
public extension Date {
    ...
    internal static func componentFlags() -> Set<Calendar.Component> { return [Calendar.Component.year,
    ...
    private static func cachedFormatter(_ format: String = DateFormatType.standard.stringFormat,
    ...
    private static func cachedFormatter(_ dateStyle: DateFormatter.Style,
